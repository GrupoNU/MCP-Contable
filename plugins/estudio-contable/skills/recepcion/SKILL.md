...
1. **Verificar perfil global:** si el playbook tiene `[PLACEHOLDER]` en la sección 1, ofrecé correr
   `/estudio-contable:cold-start-interview` antes de derivar trabajo sustantivo (así el área no
...
4. **Derivar:**
   - **Una sola área:** derivá al skill de entrada del área (p. ej.
     `/impuestos-liquidaciones:consulta-impuestos`), pasando el contexto del perfil global.
