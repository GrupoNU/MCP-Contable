...
persistir un perfil que reemplaza los `[PLACEHOLDER]` del playbook (`CLAUDE.md` del plugin). El
...
2. Leé el perfil del área en
   `~/.claude/plugins/config/mcp-contable/impuestos-liquidaciones/CLAUDE.md` si existe; si no, leé
   la plantilla del plugin (`CLAUDE.md`).
...
2. Escribí el resultado en
   `~/.claude/plugins/config/mcp-contable/impuestos-liquidaciones/CLAUDE.md`. Creá las carpetas
