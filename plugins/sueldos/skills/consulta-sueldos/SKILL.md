...
Responder una consulta de nómina general aplicando el **playbook** del plugin y las reglas de
...
1. **Verificar perfil:** si el playbook tiene `[PLACEHOLDER]` en la sección 1, ofrecé correr
   `/sueldos:cold-start-interview` antes de producir trabajo sustantivo. Si no, usá el
