...
Responder una consulta de cumplimiento societario y registral aplicando el **playbook** del plugin y
...
1. **Verificar perfil:** si el playbook tiene `[PLACEHOLDER]` en la sección 1, ofrecé correr
   `/societario-cumplimiento:cold-start-interview` antes de producir trabajo sustantivo. Si no, usá el
