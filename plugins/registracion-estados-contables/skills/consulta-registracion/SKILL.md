...
Responder una consulta de registración o estados contables aplicando el **playbook** del plugin y las
...
1. **Verificar perfil:** si el playbook tiene `[PLACEHOLDER]` en la sección 1, ofrecé correr
   `/registracion-estados-contables:cold-start-interview` antes de producir trabajo sustantivo. Si no,
