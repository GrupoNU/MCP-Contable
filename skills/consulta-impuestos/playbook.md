...
- El **perfil del usuario/entidad** (rol, régimen, jurisdicción, carpetas locales) lo completa el
  skill `perfil-impuestos`, que toma esta sección 1 como referencia de campos.
- Mientras el perfil persistido no exista o tenga campos sin completar, Claude debe **ofrecer correr
  `/mcp-contable:perfil-impuestos`** antes de producir trabajo sustantivo.
- El perfil persistido vive en:
  `~/.claude/plugins/config/mcp-contable/perfil-impuestos.md`
