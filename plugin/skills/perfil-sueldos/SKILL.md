...
**dotación** y **carpetas locales de trabajo**, y persistir un perfil personalizado tomando como
referencia los campos de la plantilla del playbook del área (`skills/consulta-sueldos/playbook.md`,
sección 1). El perfil ajusta el encabezado de
...
2. Leé el perfil del área en
   `~/.claude/plugins/config/mcp-contable/perfil-sueldos.md` si existe; si no, usá como referencia
   de campos la plantilla del playbook del área (`skills/consulta-sueldos/playbook.md`).
...
1. Tomá como **referencia de campos** la plantilla del playbook del área
   (`skills/consulta-sueldos/playbook.md`, sección 1) y escribí las respuestas **en prosa** (no YAML,
   no JSON).
2. Escribí el resultado en
   `~/.claude/plugins/config/mcp-contable/perfil-sueldos.md`. Creá las carpetas intermedias si no
   existen.
